...
Public Class WebServiceGetDataMaster
    ...
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionTrmCategory(ByVal TrxUserName As String, ByVal TenantID As String, ByVal MainCategoryID As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_TrxCategory '0','" & UserNameXSS & "','" & TenantID & "','" & MainCategoryID & "','" & NameXSS & "','" & TrxStatus & "','" & TrxAction & "'"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function SelectTransactionTrmCategory(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TenantID As String, ByVal MainCategoryID As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()

        Dim TrxAction As String = "SELECT"
        Dim NameSP = "Exec UIDESK_TrxCategory"
        Dim ExecSP = "" & NameSP & " '" & TrxID & "','" & TrxUserName & "','" & TenantID & "','" & MainCategoryID & "','" & TrxName & "','" & TrxStatus & "','" & TrxAction & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function TableTransactionTrmDepartment(ByVal TrxUserName As String, ByVal TenantID As String, ByVal TrxName As String, ByVal TrxEmail As String, ByVal TrxStatus As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function CheckTransactionTrmDepartment(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxEmail As String, ByVal TrxStatus As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()

        Dim TrxAction As String = "Check"
        Dim NameSP = "Exec UIDESK_TrxDepartment"
        Dim ExecSP = "" & NameSP & " '" & TrxUserName & "','" & TrxName & "','" & TrxEmail & "','" & TrxStatus & "','" & TrxAction & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionTrmDepartment(ByVal TrxUserName As String, ByVal TenantID As String, ByVal TrxName As String, ByVal TrxEmail As String, ByVal TrxStatus As String) As String
        Dim UserNameXSS As String = AntiXssEncoder.HtmlEncode(TrxUserName.Trim, True)
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxDepartment '0','" & UserNameXSS & "','" & TenantID & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & AntiXssEncoder.HtmlEncode(TrxEmail.Trim, True) & "','" & TrxStatus & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionTrmDepartment(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TenantID As String, ByVal TrxName As String, ByVal TrxEmail As String, ByVal TrxStatus As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxDepartment '" & TrxID & "','" & UserNameXSS & "','" & TenantID & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & AntiXssEncoder.HtmlEncode(TrxEmail.Trim, True) & "','" & TrxStatus & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function SelectTransactionTrmGroupAgent(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxStatus As String, ByVal TrxAction As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()
    ...
    Public Function InsertTransactionTrmGroupAgent(ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        ...
        Finally
            ...
            If _Result = "Success" Then
                ...
                strExec = "exec UIDESK_TrxGroupAgent '0','" & UserNameXSS & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxStatus & "','" & TrxAction & "'"
                LogSuccess(HttpContext.Current.Session("UserName"), strExec)
            ElseIf _Result = "already exits" Then
                objectTickets.Result = "Exits"
                objectTickets.TrxID = _Valuenya
                objectTickets.TrxmsgSystem = _Valuenya
                listTickets.Add(objectTickets)
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function DeleteTransactionTrmCsStatus(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
        ...
        Finally
            ...
            If _Result = "Success" Then
                objectTickets.Result = "True"
                objectTickets.TrxID = _Valuenya
                objectTickets.TrxmsgSystem = "Data Customer Status Has Been Delete"
                listTickets.Add(objectTickets)
                strExec = "exec UIDESK_TrxCustomerStatus '" & TrxID & "','" & UserNameXSS & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxStatus & "','" & TrxAction & "'"
                LogSuccess(HttpContext.Current.Session("UserName"), strExec)
            Else
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionTrmProductType(ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxProductType '0','" & UserNameXSS & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxStatus & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionTrmProductType(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxStatus As String, ByVal TrxAction As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxProductType '" & TrxID & "','" & TrxUserName & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxStatus & "','" & TrxAction & "'"
            LogError(strLogTime, ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    Public Function TableTransactionTrmCategoryType(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        ...
        Dim ExecSP = "" & NameSP & " '" & TrxID & "','0','0','0','" & TrxUserName & "','" & TrxName & "','" & TrxStatus & "','" & TrxAction & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
                Dim sqlComm As SqlCommand = New SqlCommand("UIDESK_TrxCategoryType", conn)
                sqlComm.Parameters.AddWithValue("@TrxID", TrxID)
                sqlComm.Parameters.AddWithValue("@TenantID", "0")
                sqlComm.Parameters.AddWithValue("@MainCategoryID", "0")
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionTrmCategoryType(ByVal TenantID As String, ByVal MainCategoryID As String, ByVal TrxCategoryID As String, ByVal TrxName As String,
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxCategoryType " & ",'" & TrxCategoryID & "','" & AntiXSS & "','" & TrxStatus & "','" & UserNameXSS & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionTrmCategoryDetail(ByVal TenantID As String, ByVal MainCategoryID As String, ByVal TrxCategoryID As String, ByVal TrxSubCategory1ID As String, ByVal TrxName As String,
                                                     ByVal TrxStatus As String, ByVal TrxUserName As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxCategoryDetail '0','" & TenantID & "','" & MainCategoryID & "','" & TrxCategoryID & "','" & TrxSubCategory1ID & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxStatus & "','" & UserNameXSS & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionTrmCategoryDetail(ByVal TrxID As String, ByVal TrxCategoryID As String, ByVal TrxSubCategory1ID As String, ByVal TrxName As String,
                                                     ByVal TrxStatus As String, ByVal TrxUserName As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
    ...
    Public Function InsertTransactionTrmCategoryReason(ByVal TrxCategoryID As String, ByVal TrxSubCategory1ID As String, ByVal TrxSubCategory2ID As String, ByVal TrxName As String,
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxCategoryReason '0','" & TrxCategoryID & "','" & TrxSubCategory1ID & "','" & TrxSubCategory2ID & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxEscalationUnit & "','" & TrxLayer & "','" & AntiXssEncoder.HtmlEncode(TrxSLA.Trim, True) & "','" & TrxStatus & "','" & UserNameXSS & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
                ...
                listTickets.Add(objectTickets)
                strExec = "exec UIDESK_TrxCategoryReason '0','" & TrxCategoryID & "','" & TrxSubCategory1ID & "','" & TrxSubCategory2ID & "','" & HttpUtility.UrlDecode(TrxName) & "','" & TrxEscalationUnit & "','" & TrxLayer & "','" & AntiXssEncoder.HtmlEncode(TrxSLA.Trim, True) & "','" & TrxStatus & "','" & UserNameXSS & "','" & TrxAction & "'"
                LogSuccess(HttpContext.Current.Session("UserName"), strExec)
            Else
                objectTickets.Result = "False"
                objectTickets.TrxID = _Valuenya
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionTrmCategoryReason(ByVal TrxID As String, ByVal TrxCategoryID As String, ByVal TrxSubCategory1ID As String,
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxCategoryReason '" & TrxID & "','" & TrxCategoryID & "','" & TrxSubCategory1ID & "','" & TrxSubCategory2ID & "','" & HttpUtility.UrlDecode(TrxName) & "','" & TrxEscalationUnit & "','" & TrxLayer & "','" & AntiXssEncoder.HtmlEncode(TrxSLA.Trim, True) & "','" & TrxStatus & "','" & UserNameXSS & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    Public Function TableTransactionTrmSettingUser(ByVal LevelUserID As String, ByVal TrxUserName As String) As String
        ...
        Dim ExecSP = "" & NameSP & " '0','0','0','0','0','" & TrxUserName & "','" & LevelUserID & "','" & TrxAction & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
    ...
    Public Function InsertTransactionTrmSettingUser(ByVal TrxMenuID As String, ByVal TrxSubMenuID As String, ByVal TrxTreeMenuID As String, ByVal TrxDescription As String,
                                                     ByVal TrxUserName As String, ByVal TrxLevelUserID As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
    ...
    Public Function UpdateTransactionTrmSettingUser(ByVal TrxID As String, ByVal TrxDescription As String, ByVal TrxUserName As String) As String
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxSettingManagement '" & TrxID & "','0','0','0','" & AntiXssEncoder.HtmlEncode(TrxDescription.Trim, True) & "','" & UserNameXSS & "','0','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    Public Function DeleteTransactionTrmSettingUser(ByVal TrxID As String, ByVal TrxUserName As String) As String
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxSettingManagement '" & TrxID & "','0','0','0','0','" & UserNameXSS & "','0','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    Public Function InsertTransactionUserApplication(ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxEmail As String, ByVal TrxPassword As String,
                                                     ByVal TrxLevelUser As String, ByVal TrxSite As String,
                                                     ByVal TrxDescription As String, ByVal TrxStatus As String, ByVal TrxUserCreate As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxUser '0','" & TrxUserNameXSS & "','" & TrxNameXSS & "','" & TrxEmail & "','" & TrxPassword & "','" & TrxLevelUser & "','" & TrxSite & "','" & TrxDescription & "','" & TrxStatus & "','" & TrxUserCreate & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    Public Function UpdateTransactionUserApplication(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxEmail As String, ByVal TrxPassword As String,
                                                     ByVal TrxLevelUser As String, ByVal TrxDescription As String, ByVal TrxStatus As String, ByVal TrxUserCreate As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxUser '" & TrxID & "','" & AntiXssEncoder.HtmlEncode(TrxUserName.Trim, True) & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxEmail & "','" & TrxPassword & "','" & TrxLevelUser & "','" & TrxDescriptionValue & "','" & TrxStatus & "','" & TrxUserCreate & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
