                    ...
                    <table class="table align-middle table-nowrap table-check" id="TrmCategory">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 600px;">Sub Category</th>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addContactModalLabel">Form Sub Category</h5>
                            ...
                            <div class="modal-body p-4">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        <label for="addcontact-name-input" class="form-label">Sub Category</label>
                                        <input type="text" class="form-control" id="TxtCategoryTypeName" placeholder="Sub Category">
                                    </div>
                                    <div class="mb-3">
