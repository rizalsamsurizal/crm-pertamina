    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView" runat="server" Width="100%" Visible="false"
                            DataSourceID="tempTrxSLA" Styles-Header-Font-Bold="true" Font-Size="X-Small" Theme="iOS">
                            <SettingsPager>
                                <AllButton Text="All">
                                </AllButton>
