...
Public Class Xtra_Report
    ...
    Public Function UIDESK_Xtra_Reporting(ByVal UserName As String, ByVal XStartDate As String, ByVal XEndDate As String, ByVal XReportType As String, ByVal Xtype As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()

        Dim NameSP = "Exec UIDESK_Xtra_Reporting"
        Dim ExecSP = "" & NameSP & " '" & UserName & "','" & XStartDate & "','" & XEndDate & "','" & XReportType & "','" & Xtype & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
                Dim sqlComm As SqlCommand = New SqlCommand("UIDESK_Xtra_Reporting", conn)
                sqlComm.Parameters.AddWithValue("@UserName", UserName)
                sqlComm.Parameters.AddWithValue("@XStartDate", XStartDate)
                sqlComm.Parameters.AddWithValue("@XEndDate", XEndDate)
                sqlComm.Parameters.AddWithValue("@XReportType", XReportType)
                sqlComm.Parameters.AddWithValue("@Xtype", Xtype)
