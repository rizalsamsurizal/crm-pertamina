...
Public Class ServiceCustomer1
    ...
    '                                          ByVal TrxCusTomerGender As String, ByVal TrxCusTomerDate As String, ByVal TrxCustomerPolisNumber As String, ByVal TrxCusTomerNIK As String, ByVal TrxCusTomerAlamat As String,
    '                                          ByVal TrxNumberID As String, ByVal TrxFacebook As String, ByVal TrxInstagram As String, ByVal TrxTwitter As String) As String
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionCustomer(ByVal TrxUsername As String, ByVal TrxCusTomerName As String, ByVal TrxCusTomerEmail As String, ByVal TrxCusTomerPhone As String,
                                                ByVal TrxNumberID As String, ByVal TrxTenant As String, ByVal TrxCusTomerAlamat As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxTenant", TrxTenant)
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_Temp_InsertCustomer " & "'" & TrxCustomerID & "','" & TrxUsernameXSS & "','" & HttpUtility.UrlDecode(TrxCusTomerName) & "','" & TrxCusTomerEmail & "','" & TrxCusTomerPhone & "','" & TrxTenant & "','" & HttpUtility.UrlDecode(TrxCusTomerAlamat) & "','" & TrxCustomerID & "'"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionCustomer(ByVal TrxCustomerID As String, ByVal TrxUsername As String, ByVal TrxCusTomerName As String, ByVal TrxCusTomerEmail As String, ByVal TrxCusTomerPhone As String,
                                              ByVal TrxCusTomerGender As String, ByVal TrxCusTomerDate As String, ByVal TrxCusTomerAlamat As String,
                                              ByVal TrxFacebook As String, ByVal TrxInstagram As String, ByVal TrxTwitter As String, ByVal TrxStatus As String, ByVal TrxCusTomerNIK As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Result As String = String.Empty
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxBirth", TrxCusTomerDate)
                sqlComm.Parameters.AddWithValue("TrxCIF", TrxCustomerID)
                sqlComm.Parameters.AddWithValue("TrxNIK", TrxCusTomerNIK)
                sqlComm.Parameters.AddWithValue("TrxAddress", HttpUtility.UrlDecode(TrxCusTomerAlamat))
                sqlComm.Parameters.AddWithValue("TrxFacebook", TrxFacebook)
                sqlComm.Parameters.AddWithValue("TrxInstagram", TrxInstagram)
        ...
        Catch ex As Exception
            ...
            objectTickets.msgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_Temp_UpdateCustomer '" & TrxCustomerID & "','" & HttpUtility.UrlDecode(TrxCusTomerName) & "','" & TrxCusTomerEmail & "','" & TrxCusTomerPhone & "','" & TrxCusTomerGender & "','" & TrxCusTomerDate & "','" & TrxCustomerID & "','" & TrxCusTomerNIK & "','" & HttpUtility.UrlDecode(TrxCusTomerAlamat) & "','" & TrxUsernameXSS & "','" & TrxFacebook & "','" & TrxInstagram & "','" & TrxTwitter & "','" & TrxStatus & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function ChannelCustomer(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxSearching As String, ByVal TrxAction As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()
        Dim sql As String = ""
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                ...
                sql = "Exec UIDESK_TrxCustomer '" & TrxID & "', '" & TrxUserName & "', '" & TrxSearching & "', '" & TrxAction & "'"
