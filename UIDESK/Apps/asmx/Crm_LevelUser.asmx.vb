...
Public Class Crm_LevelUser1
    ...
    Public Function LevelUserCounting(ByVal UserID As String) As String
        ...
        Dim NameSP = "Exec UIDESK_TrmLevelUser"
        Dim ExecSP = "" & NameSP & " '" & UserID & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
                Dim sqlComm As SqlCommand = New SqlCommand("UIDESK_TrmLevelUser", conn)
