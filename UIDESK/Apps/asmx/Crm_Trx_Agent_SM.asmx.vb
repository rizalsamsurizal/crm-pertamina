...
<ScriptService()>
<ToolboxItem(False)>
Public Class Crm_Trx_Agent_SM1
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertAgentDistributionData(ByVal TrxUserName As String, ByVal TrxData As String, ByVal TrxSosialMedia As String, ByVal TrxCampaign As String,
                                                ByVal TrxAccountName As String, ByVal MaxCampaign As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxAccountName", TrxAccountName)
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_TrxAgentSosialMediaSettingData '" & TrxUserNameXSS & "','" & HttpUtility.UrlDecode(TrxData) & "','" & TrxSosialMediaXSS & "','" & TrxCampaignXSS & "','" & TrxAccountName & "','" & MaxCampaignXSS & "'"
