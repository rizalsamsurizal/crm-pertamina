...
<ScriptService()>
<ToolboxItem(False)>
Public Class Crm_Trm_Category_Detail1
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionTrmCategoryDetail(ByVal TrxID As String, ByVal TenantID As String, ByVal MainCategoryID As String, ByVal TrxCategoryID As String, ByVal TrxSubCategory1ID As String, ByVal TrxName As String,
                                                     ByVal TrxStatus As String, ByVal TrxUserName As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
