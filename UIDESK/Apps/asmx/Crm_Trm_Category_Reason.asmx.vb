...
<ScriptService()>
<ToolboxItem(False)>
Public Class Crm_Trm_Category_Reason1
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionTrmCategoryReason(ByVal TenantID As String, ByVal MainCategoryID As String, ByVal TrxCategoryID As String, ByVal TrxSubCategory1ID As String, ByVal TrxSubCategory2ID As String, ByVal TrxName As String,
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_TrxCategoryReason '0','" & TenantID & "','" & MainCategoryID & "','" & TrxCategoryID & "','" & TrxSubCategory1ID & "','" & TrxSubCategory2ID & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxEscalationUnit & "','" & TrxLayer & "','" & AntiXssEncoder.HtmlEncode(TrxSLA.Trim, True) & "','" & TrxStatus & "','" & UserNameXSS & "','" & TrxAction & "'"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionTrmCategoryReason(ByVal TrxID As String, ByVal TenantID As String, ByVal MainCategoryID As String, ByVal TrxCategoryID As String, ByVal TrxSubCategory1ID As String,
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxCategoryReason '" & TrxID & "','" & TenantID & "','" & MainCategoryID & "','" & TrxCategoryID & "','" & TrxSubCategory1ID & "','" & TrxSubCategory2ID & "','" & HttpUtility.UrlDecode(TrxName) & "','" & TrxEscalationUnit & "','" & TrxLayer & "','" & AntiXssEncoder.HtmlEncode(TrxSLA.Trim, True) & "','" & TrxStatus & "','" & UserNameXSS & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
