$(document).ready(function () {
    ...
    if (getParameterByName("act") == "edit") {
        ...
        if (getParameterByName("UserType") == "QM1") {
            if (getParameterByName("type") == "Call") {

                $("#QM_PlayAudio").show();
                $("#Q1_Internal_Call").show();
                ...
                //$("#QM_PlayAudio").hide();
                $("#Q1_Internal_Call").hide();
                $("#Q1_Internal_NonCall").show();
                //$("#Q2_Eksternal_Call").hide();
                //$("#Q2_Eksternal_NonCall").hide();
                //$('#Q1_NonCall_HeaderName').append("Header " + getParameterByName("type"))
                //$('#labelQuestionName').append("Question " + getParameterByName("type"))
        ...
        if (getParameterByName("UserType") == "QM1") {
            if (getParameterByName("type") == "Call") {
                ...
                MasterChannelSelected("Q1_Call", 0)
                //$('#Q1_Call_CmbChannel').attr("disabled", true);
                //$("#Q1_Call_WaktuInteraksi").val(dateStr);
                ...
                //$('#labelQuestionName').append("Question " + getParameterByName("type"))
                //$('#labelQuestionName').append("Question " + getParameterByName("type"))
                //$("#Q1_NonCall_WaktuInteraksi").val(dateStr);

            }
        }

        //$("#QA_Name").text($("#hd_NameKaryawan").val())
        //$("#Q1_NonCall_NamaQA").text($("#hd_NameKaryawan").val())
        //$("#Q2_Call_NamaQA").text($("#hd_NameKaryawan").val())
        //$("#Q2_NonCall_NamaQA").text($("#hd_NameKaryawan").val())
            ...
            for (i = 0; i < json.length; i++) {
                ...
                if (QA_UserType == "Q1_Call") {
                    ...
                    if ($("#QM_LevelUser").val() == "QA" || $("#QM_LevelUser").val() == "Supervisor_QA" || $("#QM_LevelUser").val() == "Supervisor_Agent" || $("#QM_LevelUser").val() == "Admin_Release" || $("#QM_LevelUser").val() == "Administrator") {
                        $("#Q1_Call_NamaQA").text(json[i].qa_fullname)
                    } else {
                        $("#Q1_Call_NamaQA").text("**********")
                    }
                    $("#Q1_Call_CmbChannel").val(json[i].channel)
            ...
            for (i = 0; i < json.length; i++) {
                ...
                if (json[i].ResultType == "1") {
                    ...
                    var form_data = JSON.stringify({
                        Q1_Call_NamaAgent: $("#hd_sessionLogin").val(), Q1_Call_CmbChannel: $("#Q1_Call_CmbChannel").val(), Q1_Call_CmbJenisPermasalahan: $("#Q1_Call_CmbJenisPermasalahan").val(),
                        Q1_Call_NoTiket: $("#Q1_Call_NoTiket").val(), Q1_Call_Calltype: $("#Q1_Call_Calltype").val(), Q1_Call_NamaNasabah: $("#Q1_Call_NamaNasabah").val(),
                        Q1_Call_NomorKartu: $("#Q1_Call_NomorKartu").val(), Q1_Call_WaktuInteraksi: Q1_Call_WaktuInteraksi, Q1_Call_Durasi: $("#Q1_Call_Durasi").val(),
                        Q1_Call_NomorTelepon: $("#Q1_Call_NomorTelepon").val(), Q1_Call_PeriodePenilaian: $("#Q1_Call_PeriodePenilaian").val(), Q1_Call_UserType: getParameterByName("UserType"), Q1_Call_Type: getParameterByName("type"),
                        Q1_Call_QaID: getParameterByName("qaid"), Q1_Call_AcraID: getParameterByName("acraid"), Q1_Call_AgentID: getParameterByName("agentid"), Q1_Call_ActionType: ActionType,
...
function Q1_Call_InsertNilai(KodeGrup, KodePertanyaan, KodeNilai, Nilai, Action) {
    if (getParameterByName("act") == "edit") {
        ...
        if ($("#Q1_Call_CmbChannel").val() == "Pilih" || $("#Q1_Call_CmbChannel").val() == "") {
            ClearRadioButton();
            swal(
                '',
                'Channel Empty',
        ...
        if ($("#Q1_Call_CmbJenisPermasalahan").val() == "Pilih" || $("#Q1_Call_CmbJenisPermasalahan").val() == "") {
            ClearRadioButton();
            swal(
                '',
                'Jenis Permasalahan Empty',
        ...
        if ($("#Q1_Call_PeriodePenilaian").val() == "") {
            ClearRadioButton();
            swal(
                '',
                'Periode Penilaian Empty',
    ...
    var form_data = JSON.stringify({
        QM_HeaderID: QM_HeaderID, QM_AcraID: AcraID, QM_AgentID: getParameterByName("agentid"),
        QM_QaName: $("#hd_sessionLogin").val(), QM_UserType: getParameterByName("UserType"), QM_Type: getParameterByName("type"),
        QM_Channel: $("#Q1_Call_CmbChannel").val(), QM_QaID: getParameterByName("qaid"), QM_KodeGrup: KodeGrup, QM_KodePertanyaan: KodePertanyaan, QM_KodePenilaian: KodeNilai,
...
function ButtonActionInteractionSubmit() {
    ...
    var form_data = JSON.stringify({
        ...
        QM_Status: $("#Interaction_ComboStatus").val(), QM_Kesimpulan: KesimpulanSaran, QM_Rating: $("#RatingPenilaian").val(),
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                ResultJourNeyHistoryPenilaian = '<div class="col-xl-4 col-sm-6">' +
                    ...
                    '<span class="badge rounded-pill badge-soft-primary font-size-12">' + json[i].jenis_permasalahan + '</span>' +
                    '</div>' +
                    '</div>' +
                    '</div> ' +
                    '</div>'
