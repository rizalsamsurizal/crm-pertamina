...
function ComboMasterQA() {
    ...
    $.ajax({
        ...
        data: "{TrxID: '0', TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxStatus:'Dropdown', TrxAction:'UIDESK010'}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
...
function ComboMasterJenisQA(Req_ID) {
    ...
    $.ajax({
        type: "POST",
        url: "asmx/QA_TrmGrupPertanyaan.asmx/QM_TrxDropdown",
        data: "{TrxID:'" + Req_ID + "', TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxStatus:'Dropdown', TrxAction: 'UIDESK011'}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
