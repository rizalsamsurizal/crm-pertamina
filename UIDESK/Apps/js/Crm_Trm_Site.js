    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                $("#cmbStatus option:selected").val(json[i].Status);
            }
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                //    ID: $("#ContentPlaceHolder1_TrxID").val(), Site: $ESAPI.encoder().encodeForHTML($("#TxtSite").val()),
                //    Location: $ESAPI.encoder().encodeForHTML($("#TxtLocation").val()), Status: $("#cmbStatus").val(),
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $("#LoaderPage").show();
                //var form_data = JSON.stringify({
                //    ID: "0", Site: $ESAPI.encoder().encodeForHTML($("#TxtSite").val()),
                //    Location: $ESAPI.encoder().encodeForHTML(), Status: $("#cmbStatus").val(),
