            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        data: "{TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxData: '" + encodeData($("#ContentPlaceHolder1_TrxAgentId").val()) + "', TrxCampaign: '" + $("#CmbAccountEmail").val() + "', MaxCampaign: '" + $("#CmbMaxCampaign").val() +"'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (data) {
