    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            json.forEach(async (item) => {
                ...
                //$('#cmbCategory option:selected').text(item.CategoryName);
                $("#cmbCategoryType option:selected").text(item.CategoryType);
                $('#TxtCategoryTypeName').val(item.SubName);
                $("#cmbStatus option:selected").text(item.Status);
                ...
                $("#ContentPlaceHolder1_Hd_CmbCategoryType").val(item.SubCategory1ID);
