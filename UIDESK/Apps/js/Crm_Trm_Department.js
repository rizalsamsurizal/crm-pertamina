...
function TrmDepartment() {
    ...
    $.ajax({
        ...
        data: "{TrxUserName: '" + $("#hd_sessionLogin").val() + "', TenantID: '0', TrxName: '0', TrxEmail: '0', TrxStatus: '0'}",
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                myTable.row.add([json[i].ORGANIZATION_ID, json[i].NamaGrup, json[i].ORGANIZATION_NAME, json[i].EMAIL, Status, urlclick]).draw(false);
            }
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            var form_data = JSON.stringify({
                                TrxUserName: $("#hd_sessionLogin").val(), TenantID: TenantID, TrxName: TrxName,
