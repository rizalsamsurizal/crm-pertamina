...
function ActionSimpan() {
    ...
    var CmbMainCategoryText = $("#CmbMainCategory").find("option:selected").text();
    var CmbMainCategoryValue = $("#CmbMainCategory").val();
    ...
    var TxtReasonName = $("#TxtCategoryReasonName").val();
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                var form_data = JSON.stringify({
                    TenantID: CmbTenantValue, MainCategoryID: CmbMainCategoryValue, TrxCategoryID: CmbCategoryValue, TrxSubCategory1ID: CmbCategoryTypeValue, TrxSubCategory2ID: CmbCategoryDetailValue,
                ...
                $.ajax({
                    url: "asmx/Crm_Trm_Category_Reason.asmx/InsertTransactionTrmCategoryReason",
                    method: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: form_data,
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: "asmx/Crm_Trm_Category_Reason.asmx/UpdateTransactionTrmCategoryReason",
                    method: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: form_data,
...
function ChangeFilterDetailSubCategory(value) {
    var selectedText = $("#cmbCategoryType").find("option:selected").text();
    var selectedValue = $("#cmbCategoryType").val();
    console.log("Selected Text: " + selectedText + " Value: " + selectedValue);
    $("#ContentPlaceHolder1_Hd_CmbCategoryType").val(selectedValue)
    ...
    $.ajax({
        type: "POST",
        url: "asmx/Crm_Trm_Category_Reason.asmx/OnChangeTransactionTrmCategoryDetail",
        data: "{TrxID:'" + selectedValue + "', TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxName: '0', TrxStatus: '0'}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
