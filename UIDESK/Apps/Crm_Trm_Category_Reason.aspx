                    ...
                    <table class="table align-middle table-nowrap table-check" id="TrmCategory">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 150px; min-width: 150px;">Sub Category</th>
                                <th style="width: 150px; min-width: 150px;">Detail Sub Category</th>
                                <th style="width: 150px; min-width: 150px;">Detail Sub Category 2</th>
                                <th style="width: 150px; min-width: 150px;">Case Owner</th>
                    ...
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="myExtraLargeModalLabel">Form Detail Sub Category 2</h5>
                                ...
                                <div class="row">                                  
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="cmbCategoryType" onchange="ChangeFilterDetailSubCategory()">
                                                <option>Select</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                      ...
                                      <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="addcontact-designation-input" class="form-label">Case Owner</label>
