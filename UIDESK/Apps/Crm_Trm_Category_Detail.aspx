<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Crm_Trm_Category_Detail.aspx.vb" Inherits="UIDESK.Crm_Trm_Category_Detail" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/Crm_Trm_Category_Detail.js"></script>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <%--<h5 class="card-title">Data Enquiry Detail</h5>--%>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="d-flex flex-wrap align-items-start justify-content-md-end mt-2 mt-md-0 gap-2 mb-3">
                            <div>
                                <a href="#" class="btn btn-light" data-bs-toggle="modal" onclick="Tambah()"><i class="uil uil-plus me-1"></i>+ Add New</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table align-middle table-nowrap table-check" id="TrmCategory">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 200px;">Detail Sub Category</th>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addContactModalLabel">Form Detail Sub Category</h5>
                            ...
                            <div class="modal-body p-4">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="CmbMainCategory" onchange="ChangeFilterCategory()">
                                            <option>Select</option>
                                        </select>
                                    </div>
                                    <%--  <div class="mb-3">
                                        <label for="addcontact-designation-input" class="form-label">Category</label>
                                        <select class="form-select" id="cmbCategory" onchange="cmbCategoryChange(1)">
                                            <option>Select</option>
                                        </select>
                                    </div>--%>
                                    <div class="mb-3">
                                        <label for="addcontact-designation-input" class="form-label">Category</label>
                                        <select class="form-select" id="cmbCategory" onchange="ChangeFilterSubCategory()">
                                            <option>Select</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="addcontact-designation-input" class="form-label">Sub Category</label>
                                        <select class="form-select" id="cmbCategoryType" onchange="getWS_cmbCategoryType(1)">
                                            <option>Select</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="addcontact-name-input" class="form-label">Detail Sub Category</label>
                                        <input type="text" class="form-control" id="TxtCategoryTypeName" placeholder="Detail Sub Category">
                                    </div>
                                    <div class="mb-3">
