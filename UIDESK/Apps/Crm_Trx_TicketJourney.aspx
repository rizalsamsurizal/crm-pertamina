...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="InteractionTenantID" runat="server" />
                            ...
                            <div class="card border shadow-none">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                <textarea id="AlamatPelapor" name="AlamatPelapor" class="form-control" rows="6"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card border shadow-none">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <label for="workexperience-agentname-input">Agent</label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <label for="workexperience-productname-input">Main Category</label>
                                                <input type="text" class="form-control" placeholder="Main Category" id="MainCategory">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <label>Remarks</label>
                                            <textarea id="TextProblem" name="TextProblem" class="form-control" rows="6"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            <label for="workexperience-priorityscale-input">Status</label>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            <label for="workexperience-priorityscale-input">Case Owner</label>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            <label for="workexperience-ticketstatus-input">Eskalasi</label>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label>Problem</label>
                                        <textarea id="EskalasiResponse" name="EskalasiResponse" class="form-control" rows="6"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
