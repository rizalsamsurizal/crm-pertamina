                    ...
                    <table class="table align-middle table-nowrap table-check" id="TableHours">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 300px; min-width: 300px;">Jam Mulai</th>
                                <th style="width: 300px; min-width: 300px;">Jam Selesai</th>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addContactModalLabel">Form Jam Operasional</h5>
