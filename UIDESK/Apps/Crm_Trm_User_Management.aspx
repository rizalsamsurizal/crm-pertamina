<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Crm_Trm_User_Management.aspx.vb" Inherits="UIDESK.Crm_Trm_User_Management" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/Crm_Trm_User_Management.js"></script>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <div class="mb-3">
                        <label for="addcontact-designation-input" class="form-label">Menu Level 1</label>
                        <select id="cmbMenu1" class="form-select" onchange="getWS_CategoryType(1);">
                            <option value="">Select</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="addcontact-designation-input" class="form-label">Menu Level 2</label>
