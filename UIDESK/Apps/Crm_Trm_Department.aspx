                    ...
                    <table class="table align-middle table-nowrap table-check" id="TrmCategory">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 300px; min-width: 300px;">Tenant</th>
                                <th style="width: 300px; min-width: 300px;">Case Owner</th>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addContactModalLabel">Form Case Owner</h5>
                            ...
                            <div class="modal-body p-4">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        <label for="addcontact-name-input" class="form-label">Case Owner</label>
                                        <input type="text" class="form-control" id="TxtDepartment" placeholder="Case Owner">
                                    </div>
                                    <div class="mb-3">
